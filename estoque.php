...
<body>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
        var addItemModal = document.getElementById("myModal");
        var addItemForm = addItemModal.querySelector("form");

        var openModalBtn = document.querySelector(".btn-outline-secondary");
        openModalBtn.onclick = function() {
            addItemModal.style.display = "block";
        };

        // botão de fechar
        var closeModalElements = document.querySelectorAll(".close, .close-modal");
